...
export default function Navbar() {
  const NavigationButton = ({ text, to }) => {
    return (
      <Link to={to} className="bg-amber-300 text-white hover:text-primary flex items-center justify-center px-5 py-1.5 xl:py-3 gap-2.5  transition-colors duration-300">
