...
function OtherNavbar(){
    return(
        <>
        <div className="w-full h-[90px] bg-white flex flex-row justify-around items-center">
            <Link to="/" className="text-[24px] hidden lg:inline-block">Symphony Music Institute</Link>
            <div className="w-4/10 h-[60px] flex flex-row text-[24px] gap-6 items-center justify-evenly font-medium">
